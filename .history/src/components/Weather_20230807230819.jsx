...
<h1 className="absolute top-0 left-0 w-full h-full flex items-center justify-center text-black font-lato text-sm font-light">{weatherInfo?.name}, {weatherInfo?.sys?.country}</h1>
...
<section className={`${
      ...
      } p-2 rounded-md bg-cover bg-center w-80 h-auto filter drop-shadow(0px 4.854599475860596px 4.854599475860596px rgba(0, 0, 0, 0.25))`}
      style={{
        backgroundImage: `url(${
          isDarkMode
            ? "public/background_info_cards/card_image002_Dark version.png"
            : "public/background_info_cards/card_image001_LightVersion.png"
        })`,
      }}>
