    ...
    >
      <section className="flex">
        ...
        <div className="w-1/2 p-2 text-center">
          {/* Temperatura Actual */}
          <div className={`text-3xl font-bold font-lato w-158 h-23 top-415 left-35 font-Lato text-19 font-semibold leading-23 tracking-normal text-center bg-blue-500
