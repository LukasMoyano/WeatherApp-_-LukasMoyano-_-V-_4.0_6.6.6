...
{isDarkMode ? <img className="w-full" src="public/background_info_cads/card_image002_Dark version.png"/> : <img className="w-full" src="public/background_info_cads/card_image001_LightVersion.png"/>}
