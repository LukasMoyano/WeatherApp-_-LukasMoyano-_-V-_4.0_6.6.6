...
const Weather = ({ weatherInfo, isDarkMode }) => {
  ...
  return (
    ...
    >
      <div className="relative w-320 flex-shrink-0 p-4 rounded-lg shadow-sm">
        <svg
      ...
      <div className="flex flex-col md:flex-row md:items-start mt-4">
        <div className="md:w-2/3 md:mr-4">
          ...
          <div className="relative inset-0 bg-white opacity-50 rounded-lg"></div>
        ...
        <div className="md:w-1/3">
          <section className="grid grid-cols-2 gap-4 md:flex md:flex-row md:items-center">
