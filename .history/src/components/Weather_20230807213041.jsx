    ...
    >
      <section className="flex">
        ...
        <div className="w-1/2 p-2 text-center">
          ...
          {/* Detalles del Clima */}
          <div className="w-124 h-95 top-258 left-26 font-Lato text-79 font-light leading-95 tracking-normal text-center bg-blue-500 grid grid-cols-3 gap-2 mt-4 font-lato font-bold leading-4 ">
