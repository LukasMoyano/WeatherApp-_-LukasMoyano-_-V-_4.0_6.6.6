...
const Weather = ({ weatherInfo, isDarkMode }) => {
  ...
  return (
    <main className="grid place-items-center max-w-[600px] w-full bg-yellow-400">
      <section
        className={`bg-red-700 w-full grid grid-rows-[1fr_5fr_1fr] place-items-center relative ${isDarkMode ? " text-white" : " text-black"}`}
      >
        {/* Nombre de la Ciudad */}
        {/* País */}
        ...
        <section className="min-[400px]:w-3/5 absolute z-10 grid grid-cols-2 justify-center-items-center">
          {/* Columna Izquierda */}
