...
const Weather = ({ weatherInfo, isDarkMode }) => {
  ...
  return (
    <section
      ...
      className={`${isDarkMode ? "bg-black bg-opacity-50 text-white" : "bg-white bg-opacity-70 text-black"
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center">
          {/* Temperatura Actual */}
          <div className={`text-3xl font-bold font-lato ${isDarkMode ? "text-white" : "text-black"}`}>{convertTemperature(weatherInfo?.main.temp)}
          </div>
        </div>
          ...
          <div className="relative">
            {weatherInfo?.weather[0].icon ? (
              ...
              />
                  ...
                  {/* Imagen Logo Descripción del Clima */}
                  <h3
      ...
      <section className="flex items-center justify-center mt-4">
        <button
          ...
          className={`bg-blue-800 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mx-auto block text-xs ${isDarkMode ? "bg-opacity-70" : "bg-opacity-100"
            }`}
        >
          C°/F°
        </button>
