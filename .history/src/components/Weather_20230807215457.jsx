...
const Weather = ({ weatherInfo, isDarkMode }) => {
  ...
  return (
    <main className="flex justrify-center items-center">
      {/* Nombre de la Ciudad */}
      {/* País */}
      <h2 className="justify-center text-1xl font-bold mb-4">
      ...
      >
        <section className="flex">
          ...
          <div className="text-center">
            {/* Temperatura Actual */}
            <div
              className={` font-lato font-Lato text-79 font-semibold leading-normal tracking-normal text-center text-blue-500
